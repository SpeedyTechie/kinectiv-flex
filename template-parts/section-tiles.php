...
<div <?php if ($section_id) { echo 'id="' . $section_id . '" '; } ?>class="section c_color_<?php color_id($theme, 5); ?><?php echo $section_classes; ?>"<?php if ($section_style) { echo ' style="' . trim($section_style) . '"'; } ?>>
    <div class="section__content">
        <div class="tile-grid">
            <?php if ($section['title']) { ?><h2 class="tile-grid__title<?php if ($section['options']['layout_per-row'] == 4) { echo ' tile-grid__title_wide'; } elseif ($section['options']['layout_per-row'] == 2) { echo ' tile-grid__title_no-max-w'; } ?> title title_<?php echo $section['options']['layout_align-title']; ?> <?php echo component_colors($theme, 'title'); ?>"><?php echo $section['title']; ?></h2><?php } ?>
                                    ...
                                    <div class="info-box__buttons">
                                        <div class="button-group button-group_<?php echo $tile['options']['layout_popup-options']['layout_align']; ?>">
                                            ...
                                            <div class="button-group__item">
                                                <a href="<?php echo esc_url($button['link']['url']); ?>" target="<?php echo $button['link']['target']; ?>" class="button <?php echo $popup_button_color_classes; ?>"><?php echo $button['link']['title']; ?></a>
                                            </div>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>

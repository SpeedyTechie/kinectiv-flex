                                    ...
                                    <div class="info-box__buttons">
                                        <div class="button-group button-group_<?php echo $tile['options']['layout_popup-options']['layout_align']; ?>">
                                            ...
                                            <div class="button-group__item">
                                                <a href="<?php echo esc_url($button['link']['url']); ?>" target="<?php echo $button['link']['target']; ?>" class="button c_bg_<?php color_id($popup_theme, 3); ?> c_h_bg_<?php color_id($popup_theme, 4); ?> c_color_<?php color_id($popup_theme, 0); ?>"><?php echo $button['link']['title']; ?></a>
                                            </div>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>

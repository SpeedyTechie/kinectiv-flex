...
?>
    ...
    $f_logos = get_field('hf_footer_logos', 'option');
        ...
        <div class="site-footer__main<?php if ($f_options['layout_variation'] == 'simple') { echo ' site-footer__main_y_sm'; } ?>">
            <div class="site-footer__content">
                ...
                <div class="footer-1">
                    ...
                    <?php if ($f_logos['logos'] || $f_logos['text']): ?>
                    <div class="footer-1__bottom c_border_<?php color_id($theme, 1); ?>">
                        <div class="footer-logos">
                            <?php if ($f_logos['logos']): ?>
                            <div class="footer-logos__logos">
                                <div class="footer-logos__grid footer-logos__grid_<?php echo $f_options['layout_logo-size']; ?>">
                ...
                <div class="footer-2">
                    ...
                    <?php endif; ?>
                    <?php if ($f_logos['logos'] || $f_logos['text']): ?>
                    <div class="footer-2__section footer-2__section_logos">
                        <div class="footer-logos">
                            <?php if ($f_logos['logos']): ?>
                            <div class="footer-logos__logos">
                                <div class="footer-logos__grid footer-logos__grid_center footer-logos__grid_<?php echo $f_options['layout_logo-size']; ?>">
                                    <?php foreach ($f_logos['logos'] as $logo): ?>
                                    <div class="footer-logos__item footer-logos__item_<?php echo $f_options['layout_logo-size']; ?>">
                                        <?php if ($logo['link']) { ?><a href="<?php echo esc_url($logo['link']); ?>" target="_blank" rel="nofollow" class="footer-logos__link"><?php } ?>
                                            <img src="<?php echo $logo['logo']['url']; ?>" alt="<?php echo esc_attr($logo['logo']['alt']); ?>" width="<?php echo $logo['logo']['width']; ?>" height="<?php echo $logo['logo']['height']; ?>" class="footer-logos__logo footer-logos__logo_<?php echo $f_options['layout_logo-size']; ?>" />
